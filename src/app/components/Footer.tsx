      ...
      <div className="flex justify-between items-center px-4 md:px-8">
        ...
        <Link href="/terms">
          <span className="link mr-2 md:mr-4 bg-white border border-black text-black hover:bg-black hover:text-white rounded-full px-2 md:px-4 py-1 md:py-2 transition-all duration-200 ease-in-out font-poppins hover:animate-bounce">Terms</span>
                  ...
                  <Link href="/pages/terms" as="/privacy"  className="link mr-2 md:mr-4 bg-white border border-black text-black hover:bg-black hover:text-white rounded-full px-2 md:px-4 py-1 md:py-2 transition-all duration-200 ease-in-out font-poppins hover:animate-bounce">Privacy</Link>
          ...
          <Link href="https://www.instagram.com/ordinaryagency/" className="link bg-white border border-black text-black hover:bg-black hover:text-white rounded-full px-2 md:px-4 py-1 md:py-2 transition-all duration-200 ease-in-out font-poppins hover:animate-bounce">
