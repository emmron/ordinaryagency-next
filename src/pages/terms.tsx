    ...
    <>
      ...
      <main className="min-h-screen bg-white items-center justify-start pt-16 md:pt-20 px-4 sm:px-6 md:px-8 lg:px-12 lg:py-0 xl:px-16">
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <p>
Terms and Conditions for Ordinary Agency
...
For the purposes of these Terms and Conditions:
    ...
    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Black Pill PTY LTD, 135 Carr St, West Perth 6005.
    ...
    Website refers to Ordinary Agency, accessible from http://www.ordinaryagency.com.au
...
If you have any questions about these Terms and Conditions, You can contact us:
    ...
    By email: hello@ordinaryagency.com.au
